...
export const metadata = {
    ...
    description: 'Explore the best destinations in Africa with our eco-friendly tours and safaris.',
  };
    ...
    return (
        ...
        <div className="absolute inset-0 rounded-3xl overflow-hidden">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto">
            Experience unforgettable adventures through our carefully Afican curated travel destinations
          </p>
        </div>
            </div>
