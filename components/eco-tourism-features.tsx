...
const Feature: React.FC<FeatureProps> = ({ icon: Icon, title, description, bgColor }) => (
  <div className="flex items-center pb-8 mb-8 border-b border-gray-100 last:border-b-0 last:pb-0 last:mb-0">
    <div className={`flex-shrink-0 w-12 h-12 mr-4 ${bgColor} rounded-full flex items-center justify-center`}>
